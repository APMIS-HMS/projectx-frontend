...
@Component({
	selector: 'app-prescribe-drug-notable',
	templateUrl: './prescribe-drug-noTable.component.html',
	styleUrls: [ './prescribe-drug-noTable.component.scss' ]
})
export class PrescribeDrugNotableComponent implements OnInit {
