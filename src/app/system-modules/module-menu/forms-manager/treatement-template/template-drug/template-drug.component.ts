import { DrugListApiService } from '../../../../../services/facility-manager/setup/index';
...
@Component({
  selector: 'app-template-drug',
  templateUrl: './template-drug.component.html',
  styleUrls: ['./template-drug.component.scss']
})
export class TemplateDrugComponent implements OnInit {
